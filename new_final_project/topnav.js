<!-- <script type="text/javascript" src="topnav.js"></script> -->
  <script type="text/javascript">// create a clone of the menu, 
// create a clone of the menu, 
// which we'll only reveal when the user scrolls past a certain position
$('.topnav').addClass('original').clone().insertAfter('.topnav').addClass('cloned').css('position','fixed').css('top','0').css('margin-top','5%').css('z-index','500').removeClass('original').hide();
